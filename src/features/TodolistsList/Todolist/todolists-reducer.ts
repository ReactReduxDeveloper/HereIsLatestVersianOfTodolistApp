...
export const setTodoListsEntityStatusAC = (
  id: string,
...
export const fetchTodoListsTC =
  ...
  (
    dispatch: ThunkDispatch<
      AppRootState,
      any,
      TodoListActionType | SetStatusActionType | SetErrorActionType
    >
  ) => {
...
export const removeTodoListsTC =
  ...
  (
    dispatch: ThunkDispatch<
      AppRootState,
      any,
      TodoListActionType | SetStatusActionType
    >
  ) => {
    dispatch(setAppStatusAC("loading"));
...
export const changeTodolistTitleTC =
  ...
  (dispatch: ThunkDispatch<AppRootState, any, TodoListActionType>) => {
