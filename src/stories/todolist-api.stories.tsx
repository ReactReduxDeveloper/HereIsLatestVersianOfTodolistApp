...
import {TaskPriorities, TaskStatues, todolistsApi} from "../api/todolists_api";
...
export const CreateTodolist = () => {
    ...
    return <div>
        ...
        <input value={title} placeholder={"Type Title of Todolist"} onChange={titleOnChange}/>
        <div>
...
export const DeleteTodolist = () => {
    ...
    return <div>
        {JSON.stringify(state)}
        <input value={todolistId} placeholder={"Type TodolistID"} onChange={todolistOnChange}/>
        <div>
...
export const UpdateTodolistTitle = () => {
    ...
    return <div>
        {JSON.stringify(state)}
        <input value={todolistId} placeholder={"Type TodolistID"} onChange={todolistOnChange}/>
        <input value={title} placeholder={"Type newTitle"} onChange={titleOnChange}/>
        <div>
...
export const DeletTasks = () => {
    ...
    return <div>
        {JSON.stringify(state)}
        <div>
            <input value={todolistId} placeholder={"text TodolistID"} onChange={todoListOnChange}/>
            <input value={taskId} placeholder={"text TaskID"} onChange={taskOnChange}/>
...
export const CreateTask = () => {
    ...
    return <div>
        ...
        <div>
            <input value={todolistId} placeholder={"text TodolistID"} onChange={todoListOnChange}/>
            <input value={title} placeholder={"text Title"} onChange={titleOnChange}/>
